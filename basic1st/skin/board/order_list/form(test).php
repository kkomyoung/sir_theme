   ...
   <!-- 게시물 작성/수정 시작 { -->
    ...
    <?php if ($is_admin=="super") { ?>
        <tr>
			...
			<td>&nbsp;&nbsp;<input name="wr_10" type="radio" id="wr_10" value="견적접수" <?php if($write['wr_10']=="견적접수") echo "checked";?>>&nbsp;&nbsp;견적접수&nbsp;&nbsp;
				<input type="radio" <?php if($write['wr_10']=="견적완료") echo "checked";?> name="wr_10" value="견적완료" id="wr_10">&nbsp;&nbsp;<span class="견적완료">견적완료</span></td>
        </tr>
        <?php } ?>
