...
<section id="bo_w">
    ...
    <div class="write_div">
        <label for="wr_phone" class="sound_only">전화번호</label>
        <input type="text" name="wr_1" value="<?php echo $wr_1 ?>" id="wr_1" class="frm_input full_input" size="50" placeholder="010-0000-0000">
    </div>
