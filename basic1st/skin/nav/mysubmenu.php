<style TYPE="text/css">
<!--
	#mysubmenu{width: 70%;margin:0 auto;}
	...
	#snb .snb2dul > li:nth-child(2){border-left:0 none;border-right:0 none;}
	#snb .snb2dul > li a{
		display:block;width: 100%;line-height:50px;
		color:#fff;font-size:1.4em;font-family: 'Nanum Myeongjo';
	}
	#snb .snb2dul > li.active{
		background: #fff;
	}
	#snb .snb2dul > li.active a{color:#000;}

	#snb .snb2dul > li a b i{display:none}
